...
abstract class MicroserviceJobUtils {
    ...
    static JobComponent<Job> configureGit(MicroserviceProject project, String gitRef = 'master') {
        return component {
            scm {
                git {
                    remote {
    ...
    static JobComponent<Job> configureGit(MicroserviceProject project, MicroserviceVersion version) {
